/*
THIS CODE IS A CARBON COPY OF THE BELA API
For the original file, see here: https://github.com/BelaPlatform/Bela/blob/master/IDE/public/gui/js/BelaData.js
*/

import BelaWebSocket from './BelaWebSocket.js'

export default class BelaData extends BelaWebSocket {
	constructor(port = 5555, address = 'gui_data', ip) {
