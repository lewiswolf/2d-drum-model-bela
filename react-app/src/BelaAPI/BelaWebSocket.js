/*
THIS CODE IS AN EDITED VERSION OF THE BELA API
For the original file, see here: https://github.com/BelaPlatform/Bela/blob/master/IDE/public/gui/js/BelaWebSocket.js
*/
...
export default class BelaWebSocket {
	...
	onClose(event) {
		...
		const disconnectEvent = new CustomEvent('BelaDisconnected')
	...
	onOpen() {
		...
		// fire connect event
		const connectEvent = new CustomEvent('BelaConnected')
